...
| `titles.concept`             | `{ conceptId: string; titleIds: string[]; }`                      | The concept is a single identifier for the various versions of a game. This object contains various metadata including the conceptId and the various Title Ids for this game. <br> **Example:** `{ conceptId: "12345", titleIds: ["CUSA01433_00", "CUSA01433_01"] }` |
| `titles.concept.conceptId`   | `string`                                                          | Identifier for the concept. <br> **Example:** `"12345"`                                                                                                                                                                                                              |
